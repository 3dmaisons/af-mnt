...
set LOG=$1
set TRAIN=/home/alta/BLTSpeaking/exp-ytl28/encdec/run-v9/debug.sh
...
#set CMD = `qsub -cwd -j yes -o $LOG -P esol -l hostname=air205.eng.cam.ac.uk -l qp=cuda-low -l gpuclass='*' -l osrel='*' $TRAIN`
echo $CMD
