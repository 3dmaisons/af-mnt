...
smooth_epochs_str=3_7_22 # 1_10_11 3_9_18 9_19_20

ss_max=0.2 # 0.2 0.1
# SAVE_DIR=results/models-v9enfr/aaf-v0004-ss-max${ss_max}/
# SAVE_DIR=results/models-v9enfr/aaf-v0004-ss-max${ss_max}linear/
